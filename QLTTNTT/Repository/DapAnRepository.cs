        ...
        public async Task<DapAn> Add(DapAn data)
        {
            using (SqlConnection conn = IConnectData())
            {
                try
                {
                    ...
                    DapAn item = conn.QueryFirstOrDefault<DapAn>("SP_QLTTNTT_DapAn_Add", parameters, commandType: CommandType.StoredProcedure);
                    return item;
                }
                catch (Exception ex)
                {
        ...
        public async Task<DapAn> Edit(DapAn data)
        {
            using (SqlConnection conn = IConnectData())
            {
                try
                {
                    ...
                    parameters.Add("@CauTraLoi", data.CauTraLoi);
                    parameters.Add("@DapAnDung", data.DapAnDung);
                    DapAn item = conn.QueryFirstOrDefault<DapAn>("SP_QLTTNTT_DapAn_Edit", parameters, commandType: CommandType.StoredProcedure);
                    return item;
                }
                catch (Exception ex)
                {
        ...
        public async Task<IEnumerable<DapAn>> GetByID_Dung(int id)
        {
            using (SqlConnection conn = IConnectData())
            {
                try
                {
                    ...
                    IEnumerable<DapAn> list = conn.Query<DapAn>("SP_QLTTNTT_DapAn_GetByCauHoiID_Dung", parameters, commandType: CommandType.StoredProcedure);
                    return list;
                }
                catch (Exception ex)
                {
        ...
        public async Task<IEnumerable<DapAn>> GetByID_Sai(int id)
        {
            using (SqlConnection conn = IConnectData())
            {
                try
                {
                    ...
                    DynamicParameters parameters = new DynamicParameters();
                    parameters.Add("@CauHoiID", id);
                    IEnumerable<DapAn> list = conn.Query<DapAn>("SP_QLTTNTT_DapAn_GetByCauHoiID_Sai", parameters, commandType: CommandType.StoredProcedure);
                    return list;
                }
                catch (Exception ex)
                {
        ...
        public async Task<int> Delete(int id)
        {
            using (SqlConnection conn = IConnectData())
            {
                try
                {
                    ...
                    DynamicParameters parameters = new DynamicParameters();
                    parameters.Add("@CauHoiID", id);
                    int item = conn.QueryFirstOrDefault<int>("SP_QLTTNTT_DapAn_Deletes", parameters, commandType: CommandType.StoredProcedure);
                    return item;
                }
                catch (Exception ex)
                {
