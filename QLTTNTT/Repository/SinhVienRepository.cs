        ...
        public async Task<IEnumerable<SinhVien>> Gets()
        {
            using (SqlConnection conn = IConnectData())
            {
                try
                {
                    ...
                    IEnumerable<SinhVien> list = conn.Query<SinhVien>("SP_QLTTNTT_SinhVien_Gets", commandType: CommandType.StoredProcedure);
                    return list;
                }
                catch (Exception ex)
                {
        ...
        public async Task<SinhVien> Add(SinhVien data)
        {
            using (SqlConnection conn = IConnectData())
            {
                try
                {
                    ...
                    SinhVien item = conn.QueryFirstOrDefault<SinhVien>("SP_QLTTNTT_SinhVien_Add", parameters, commandType: CommandType.StoredProcedure);
                    return item;
                }
                catch (Exception ex)
                {
        ...
        public async Task<SinhVien> Edit(SinhVien data)
        {
            using (SqlConnection conn = IConnectData())
            {
                try
                {
                    ...
                    parameters.Add("@HinhAnh", data.HinhAnh);
                    parameters.Add("@TrangThai", data.TrangThai);
                    SinhVien item = conn.QueryFirstOrDefault<SinhVien>("SP_QLTTNTT_SinhVien_Edit", parameters, commandType: CommandType.StoredProcedure);
                    return item;
                }
                catch (Exception ex)
                {
        ...
        public async Task<int> Delete(int id)
        {
            using (SqlConnection conn = IConnectData())
            {
                try
                {
                    ...
                    int item = conn.QueryFirstOrDefault<int>("SP_QLTTNTT_SinhVien_Delete", parameters, commandType: CommandType.StoredProcedure);
                    return item;
                }
                catch (Exception ex)
                {
        ...
        public async Task<int> Deletes(string listID)
        {
            using (SqlConnection conn = IConnectData())
            {
                try
                {
                    ...
                    int item = conn.QueryFirstOrDefault<int>("SP_QLTTNTT_SinhVien_Deletes", parameters, commandType: CommandType.StoredProcedure);
                    return item;
                }
                catch (Exception ex)
                {
        ...
        public async Task<int> Check(SinhVienCheck data)
        {
            using (SqlConnection conn = IConnectData())
            {
                try
                {
                    ...
                    parameters.Add("@SinhVienID", data.SinhVienID);
                    parameters.Add("@MaSinhVien", data.MaSinhVien);
                    int item = conn.QueryFirstOrDefault<int>("SP_QLTTNTT_SinhVien_Check", parameters, commandType: CommandType.StoredProcedure);
                    return item;
                }
                catch (Exception ex)
                {
